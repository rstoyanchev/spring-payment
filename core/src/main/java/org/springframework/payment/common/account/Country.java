...
public class Country implements Serializable {
	...
	public static final Country AMERICAN_SAMOA = new Country("AS", "American Samoa");
	...
	public static final Country ANTIGUA_AND_BARBUDA = new Country("AG", "Antigua and Barbuda");
	...
	public static final Country BOSNIA_AND_HERZEGOVINA = new Country("BA", "Bosnia and Herzegovina");
	public static final Country BOTSWANA = new Country("BW", "Botswana");
	public static final Country BOUVET_ISLAND = new Country("BV", "Bouvet Island");
	public static final Country BRAZIL = new Country("BR", "Brazil");
	public static final Country BRITISH_INDIAN_OCEAN_TERRITORY = new Country("IO", "British Indian Ocean Territory");
	public static final Country BRUNEI_DARUSSALAM = new Country("BN", "Brunei Darussalam");
	...
	public static final Country CAYMAN_ISLANDS = new Country("KY", "Cayman Islands");
	public static final Country CENTRAL_AFRICAN_REPUBLIC = new Country("CF", "Central African Republic");
	...
	public static final Country CHRISTMAS_ISLAND = new Country("CX", "Christmas Island");
	public static final Country COCOS_KEELING_ISLANDS = new Country("CC", "Cocos (Keeling) Islands");
	...
	public static final Country CONGO_THE_DEMOCRATIC_REPUBLIC_OF_THE = new Country("CD", "Congo, The Democratic Republic of the");
	...
	public static final Country COTE_DIVOIRE = new Country("CI", "Cote D'Ivoire");
	...
	public static final Country CZECH_REPUBLIC = new Country("CZ", "Czech Republic");
	...
	public static final Country DOMINICAN_REPUBLIC = new Country("DO", "Dominican Republic");
	...
	public static final Country EQUATORIAL_GUINEA = new Country("GQ", "Equatorial Guinea");
	...
	public static final Country FALKLAND_ISLANDS_MALVINAS = new Country("FK", "Falkland Islands (Malvinas)");
	public static final Country FAROE_ISLANDS = new Country("FO", "Faroe Islands");
	...
	public static final Country FRENCH_GUIANA = new Country("GF", "French Guiana");
	public static final Country FRENCH_POLYNESIA = new Country("PF", "French Polynesia");
	public static final Country FRENCH_SOUTHERN_TERRITORIES = new Country("TF", "French Southern Territories");
	...
	public static final Country GUINEA_BISSAU = new Country("GW", "Guinea-Bissau");
	public static final Country GUYANA = new Country("GY", "Guyana");
	public static final Country HAITI = new Country("HT", "Haiti");
	public static final Country HEARD_ISLAND_AND_MCDONALD_ISLANDS = new Country("HM", "Heard Island and Mcdonald Islands");
	public static final Country HOLY_SEE_VATICAN_CITY_STATE = new Country("VA", "Holy See (Vatican City State)");
	...
	public static final Country IRAN_ISLAMIC_REPUBLIC_OF = new Country("IR", "Iran, Islamic Republic Of");
	...
	public static final Country KOREA_DEMOCRATIC_PEOPLES_REPUBLIC_OF = new Country("KP", "Korea, Democratic People'S Republic of");
	public static final Country KOREA_REPUBLIC_OF = new Country("KR", "Korea, Republic of");
	public static final Country KUWAIT = new Country("KW", "Kuwait");
	public static final Country KYRGYZSTAN = new Country("KG", "Kyrgyzstan");
	public static final Country LAO_PEOPLES_DEMOCRATIC_REPUBLIC = new Country("LA", "Lao People'S Democratic Republic");
	...
	public static final Country LIBYAN_ARAB_JAMAHIRIYA = new Country("LY", "Libyan Arab Jamahiriya");
	public static final Country LIECHTENSTEIN = new Country("LI", "Liechtenstein");
	...
	public static final Country MACEDONIA_THE_FORMER_YUGOSLAV_REPUBLIC_OF = new Country("MK", "Macedonia, The Former Yugoslav Republic of");
	...
	public static final Country MARSHALL_ISLANDS = new Country("MH", "Marshall Islands");
	...
	public static final Country MICRONESIA_FEDERATED_STATES_OF = new Country("FM", "Micronesia, Federated States of");
	public static final Country MOLDOVA_REPUBLIC_OF = new Country("MD", "Moldova, Republic Of");
	...
	public static final Country NETHERLANDS_ANTILLES = new Country("AN", "Netherlands Antilles");
	public static final Country NEW_CALEDONIA = new Country("NC", "New Caledonia");
	...
	public static final Country NORFOLK_ISLAND = new Country("NF", "Norfolk Island");
	public static final Country NORTHERN_MARIANA_ISLANDS = new Country("MP", "Northern Mariana Islands");
	...
	public static final Country PALESTINIAN_TERRITORY_OCCUPIED = new Country("PS", "Palestinian Territory, Occupied");
	public static final Country PANAMA = new Country("PA", "Panama");
	public static final Country PAPUA_NEW_GUINEA = new Country("PG", "Papua New Guinea");
	...
	public static final Country RUSSIAN_FEDERATION = new Country("RU", "Russian Federation");
	...
	public static final Country SAINT_KITTS_AND_NEVIS = new Country("KN", "Saint Kitts and Nevis");
	public static final Country SAINT_LUCIA = new Country("LC", "Saint Lucia");
	public static final Country SAINT_PIERRE_AND_MIQUELON = new Country("PM", "Saint Pierre and Miquelon");
	public static final Country SAINT_VINCENT_AND_THE_GRENADINES = new Country("VC", "Saint Vincent and The Grenadines");
	public static final Country SAMOA = new Country("WS", "Samoa");
	public static final Country SAN_MARINO = new Country("SM", "San Marino");
	public static final Country SAO_TOME_AND_PRINCIPE = new Country("ST", "Sao Tome and Principe");
	...
	public static final Country SOLOMON_ISLANDS = new Country("SB", "Solomon Islands");
	...
	public static final Country SOUTH_GEORGIA_AND_THE_SOUTH_SANDWICH_ISLANDS = new Country("GS", "South Georgia and The South Sandwich Islands");
	...
	public static final Country SVALBARD_AND_JAN_MAYEN = new Country("SJ", "Svalbard and Jan Mayen");
	...
	public static final Country SYRIAN_ARAB_REPUBLIC = new Country("SY", "Syrian Arab Republic");
	public static final Country TAIWAN_PROVINCE_OF_CHINA = new Country("TW", "Taiwan, Province of China");
	public static final Country TAJIKISTAN = new Country("TJ", "Tajikistan");
	public static final Country TANZANIA_UNITED_REPUBLIC_OF = new Country("TZ", "Tanzania, United Republic of");
	...
	public static final Country TRINIDAD_AND_TOBAGO = new Country("TT", "Trinidad and Tobago");
	...
	public static final Country TURKS_AND_CAICOS_ISLANDS = new Country("TC", "Turks and Caicos Islands");
	...
	public static final Country UNITED_ARAB_EMIRATES = new Country("AE", "United Arab Emirates");
	public static final Country UNITED_KINGDOM = new Country("GB", "United Kingdom");
	public static final Country UNITED_STATES = new Country("US", "United States");
	public static final Country UNITED_STATES_MINOR_OUTLYING_ISLANDS = new Country("UM", "United States Minor Outlying Islands");
	...
	public static final Country VIRGIN_ISLANDS_BRITISH = new Country("VG", "Virgin Islands, British");
	public static final Country VIRGIN_ISLANDS_US = new Country("VI", "Virgin Islands, U.S.");
	public static final Country WALLIS_AND_FUTUNA = new Country("WF", "Wallis and Futuna");
	public static final Country WESTERN_SAHARA = new Country("EH", "Western Sahara");
