...
public class State implements Serializable {
	...
	public static final State DISTRICT_OF_COLUMBIA = usaState("DC", "District of Columbia");
	...
	public static final State BRITISH_COLUMBIA = canadianProvince("BC", "British Columbia");
	public static final State MANITOBA = canadianProvince("MB", "Manitoba");
	public static final State NEW_BRUNSWICK = canadianProvince("NB", "New Brunswick");
	public static final State NEWFOUNDLAND_AND_LABRADOR = canadianProvince("NL", "Newfoundland and Labrador");
	public static final State NORTHWEST_TERRITORIES = canadianProvince("NT", "Northwest Territories");
	public static final State NOVA_SCOTIA = canadianProvince("NS", "Nova Scotia");
	...
	public static final State PRINCE_EDWARD_ISLAND = canadianProvince("PE", "Prince Edward Island");
	public static final State QUEBEC = canadianProvince("QC", "Quebec");
	public static final State SASKATCHEWAN = canadianProvince("SK", "Saskatchewan");
	public static final State YUKON_TERRITORY = canadianProvince("YT", "Yukon Territory");
	...
	public boolean equals(Object object) {
		...
		return (code.equals(other.getCode()) && country.equals(other.getCountry()));
	}
